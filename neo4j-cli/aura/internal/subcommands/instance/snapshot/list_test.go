...
func TestListSnapshotWithTextOutput(t *testing.T) {
	helper := testutils.NewAuraTestHelper(t)
	defer helper.Close()
	...
	helper.ExecuteCommand(fmt.Sprintf("instance snapshot list --instance-id %s --output text", instanceId))

	mockHandler.AssertCalledTimes(1)
	mockHandler.AssertCalledWithMethod(http.MethodGet)

	helper.AssertOut("afdb4e9d-6ba6-4d45-b951-f82843dcbca6\t7261d20a\tAdHoc\tCompleted\t2024-09-12T13:51:45Z")
}
